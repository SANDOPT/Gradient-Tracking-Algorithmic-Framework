...
def DIGing_2_mgrad(x_0, W, iterations, A_list, b_list, A, b, alpha, grad, grad_full, K):
...
def DIGing_2_mgrad_track(x_0, W, iterations, A_list, b_list, A, b, alpha, grad, grad_full, K, x_opt):
