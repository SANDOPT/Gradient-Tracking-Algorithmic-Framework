...
def DIGing_3R(x_0, W, iterations, A_list, b_list, A, b, alpha, grad, grad_full, p, seed):
...
def DIGing_3R_track(x, W, iterations, A_list, b_list, A, b, alpha, grad, grad_full, p, seed, x_opt):
